...
namespace UI
{
	...
	[ExecuteInEditMode, RequireComponent(typeof(CanvasRenderer), typeof(ParticleSystem)), AddComponentMenu("UI/Effects/Extensions/UIParticleSystem")]
			...
			for (int i = 0; i < count; ++i)
			{
				...
				else
				{
					if (use3dRotation)
					{
						...
						{
							new Vector3(-size, -size, 0), new Vector3(-size, size, 0), new Vector3(size, size, 0), new Vector3(size, -size, 0)
						};
