...
namespace UI.View
{
	public class UIItemAttributesView : MonoBehaviour
	{
		...
		[SerializeField]
		private Transform itemAttributeView;
		[SerializeField]
		private GameObject attributeHolderPrefab;
		[SerializeField]
		private GameObject attributeViewPrefab;
		[SerializeField]
		private GameObject UIAttributeUnlockButtonPrefab;
		[SerializeField]
		...
		private void InitializeAttributes(UpgradeAbleItemSO upgradeAbleItem, GameObject attributeHolder)
		{
			...
			foreach (KeyValuePair<ItemAttributeTypes, ItemAttributeData> attribute in upgradeAbleItem._itemAttributes)
			{
